...
// ---------------------------------------------------------------------
// Song create / edit form (with section editor)
// ---------------------------------------------------------------------
...
async function viewSongForm(content, songId) {
    ...
    <form id="song-form">
      ...
      <div class="chordpro-help">
        Write chords in square brackets right before the syllable they sit above, e.g.
        <code>[E]Take me back to where [B]I first believed</code>. They'll render as chords lined up above the lyrics automatically.
      </div>
      <div id="sections-editor" style="margin-top:14px;"></div>
    ...
    function renderSections() {
      ...
      <div class="section-editor" data-local-id="${sec._localId}">
        <div class="section-editor-head">
          ...
          <button type="button" class="btn btn-icon btn-sm" data-move="down" ${i === sections.length - 1 ? "disabled" : ""} title="Move down">▼</button>
          <button type="button" class="btn btn-icon btn-sm" data-remove title="Remove section">🗑</button>
        </div>
...
function openArrangementEditor(data, content) {
    ...
    <div id="arr-sections"></div>
    <button type="button" class="btn btn-sm" id="arr-add-section" style="margin-top:6px;">+ Add Section</button>
  ...
  `,
        {
            ...
            <div class="section-editor" data-local-id="${sec._localId}">
              <div class="section-editor-head">
                ...
                <button type="button" class="btn btn-icon btn-sm" data-move="up" ${i === 0 ? "disabled" : ""}>▲</button>
                <button type="button" class="btn btn-icon btn-sm" data-move="down" ${i === sections.length - 1 ? "disabled" : ""}>▼</button>
                <button type="button" class="btn btn-icon btn-sm" data-remove>🗑</button>
              </div>
